...
Name & Password</strong>
											...
											<form action="<?php echo site_url('studentLogin/authenticate'); ?>" method="post" enctype="multipart/form-data">
												<fieldset class="">
										...
										<div class="toolbar clearfix">
										      <div>
												 <a class="forgot-password-link" href="<?php echo site_url('adminLogin') ?>">
