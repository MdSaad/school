				...
				<div class="row">
					...
					<div class="col-md-10 col-sm-10 col-lg-10 headerBox2">
						...
						<i class="glyphicon glyphicon-forward"></i>
							<a href="<?php echo site_url('allReport'); ?>">Report</a>&nbsp;&nbsp;<i class="glyphicon glyphicon-forward"></i>&nbsp;&nbsp;<a href="<?php echo site_url('libraryReport'); ?>">Library Report</a>&nbsp;&nbsp;<i class="glyphicon glyphicon-forward"></i>&nbsp;&nbsp;<a href="<?php echo site_url('libraryReport/expiredBookIssueReport'); ?>">Expired Issue Book Report</a>
					</div>
				</div>	
	</div>
								  ...
								  <div id="widget-container-col-11" class="col-md-12 col-xs-12 col-sm-12 col-lg-12 widget-container-col ui-sortable addFormContent" style="min-height: 172px; display:block">
									<div id="widget-box-11" class="widget-box widget-color-dark ui-sortable-handle" style="opacity: 1;">
										<div class="widget-header">
											<h3 class="widget-title"><strong>Expired Issue Book Report</strong></h3>
											...
											<div class="widget-main padding-4"  style="position: relative;">
												<div class="scroll-content">
												   <div class="col-md-6" style="padding-top:10px">
												       <form class="form-horizontal" id="languageExpireForm" role="form" action="<?php echo site_url('libraryReport/languageWiseExpireBookReportAction'); ?>" enctype="multipart/form-data" method="post">							
														<div class="content img-thumbnail container" style="min-height: 292px">
												   ...
												   <div class="col-md-6" style="padding-top:10px">
												       <form class="form-horizontal" id="stuWiseExForm" role="form" action="<?php echo site_url('libraryReport/studentWiseExpireBookIssueReportAction'); ?>" enctype="multipart/form-data" method="post">							
...
$("#languageExpireForm").submit(function(e)
{
	...
	$.ajax(
	{
		...
		success:function(data){
			...
			$("#stuWiseExForm").find("input[type=text], textarea, select").val("");			
		}
	});
...
$("#stuWiseExForm").submit(function(e)
{
	var postData = $(this).serializeArray();
	console.log(postData);
	var formURL = $(this).attr("action");
	$.ajax(
	{
		...
		success:function(data){
			$("#issueBookReportView").html(data);	
			$("#languageExpireForm").find("input[type=text], textarea, select").val("");			
		}
	});
