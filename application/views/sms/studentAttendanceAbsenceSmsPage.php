											...
											<div class="widget-main padding-4"  style="position: relative;">
												...
												<div class="scroll-content">
														...
														<?php } ?>
																	...
																	<div class="form-group">
																	  <div class="col-sm-12">
																	     <textarea class="form-control" name="msg1" id="msg1" placeholder="Type a messege"></textarea>
																	 </div>
															...
															<div class="form-group">
																<div class="col-sm-12">
																	<textarea class="form-control" name="msg2" id="msg2" placeholder="Type a messege"></textarea>
																</div>
