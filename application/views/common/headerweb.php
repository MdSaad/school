...
<script type="text/javascript" language="javascript" src="<?php echo site_url('adapter/javascript'); ?>"></script>
				<div class="row">
					<div class="col-md-2 col-sm-2 col-lg-2 leftBox paddingZero">
						<img src="<?php echo base_url('resource/interface/img/headerLeftImg.png'); ?>" class="img-responsive pull-right" style="max-height:210px" />
					</div>
					<div class="col-md-10 col-sm-10 col-lg-10 middleContainer">
						...
						<div class="row">
							...
							<img src="<?php echo base_url('resource/interface/img/left2Img.png'); ?>" class="img-responsive pull-left" style="max-height:220px" />
							</div>
							...
							<div class="col-md-6 col-sm-6">
								...
								<div class="row brdrBottom">
										<div class="school_name text-center">Islami Academy School & College Trishal</div>
										<div class="school_name text-center">Main Campus</div>
										<div class="school_adrs text-center">Trishal, Mymensingh</div>
								</div>
								<div class="row">
							...
							<div class="col-md-3 col-sm-3">
							<img src="<?php echo base_url('resource/interface/img/rightImg.png'); ?>" class="img-responsive pull-right" style="max-height:220px" />
							</div>
						</div>	
					</div>
				</div>
