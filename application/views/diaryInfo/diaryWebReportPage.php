...
<html lang="en-US">
				...
				<div class="row">
					...
					<div class="col-md-10 col-sm-10 col-lg-10 headerBox2">
						...
						<i class="glyphicon glyphicon-forward"></i>
							<a>Report</a>&nbsp;&nbsp;<i class="glyphicon glyphicon-forward"></i>&nbsp;&nbsp;<a href="<?php echo site_url('diaryReport'); ?>">Student Diary Information Report</a>
					</div>
				</div>	
	</div>
	...
	<div class="col-md-11 col-lg-11">
									...
									<div class="row reportResultListView">
										<div class="col-xs-12 col-md-12 col-lg-12 col-sm-12">
											...
											<div class="table-header text-left">
												<form  role="form" action="<?php echo site_url('diaryReport/diaryReportAction'); ?>" id="diaryReportForm">
	  ...
	  <?php $this->load->view('common/footerweb'); ?>
