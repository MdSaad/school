				...
				<div class="row">
					...
					<div class="col-md-10 col-sm-10 col-lg-10 headerBox2">
						...
						<i class="glyphicon glyphicon-forward"></i>
							<a href="<?php echo site_url('allReport'); ?>">Report</a>&nbsp;&nbsp;<i class="glyphicon glyphicon-forward"></i>&nbsp;&nbsp;<a href="<?php echo site_url('hrReport'); ?>">HR Report</a>&nbsp;&nbsp;<i class="glyphicon glyphicon-forward"></i>&nbsp;&nbsp;<a href="<?php echo site_url('hrReport/empAttendanceReport'); ?>">Employee Attendence Report</a>&nbsp;&nbsp;
					</div>
				</div>	
	</div>
							...
							<div class="row text-center">
								...
								<div id="widget-box-11" class="widget-box widget-color-dark ui-sortable-handle" style="opacity: 1;">
									<div class="widget-header">
										<h3 class="widget-title"><strong>Employee Attendence Report</strong></h3>
								...
								<div class="scroll-content">
									...
									<div class="row">
										<div class="col-xs-12 col-md-12 col-lg-12 col-sm-12">
											...
											<div class="text-left">
												<form target="_blank" class="form-horizontal" id="attendenceReportForm" role="form" action="<?php echo site_url('hrReport/empAttendenceReportAction'); ?>" enctype="multipart/form-data" method="get">	
												<div class="scroll-content">
