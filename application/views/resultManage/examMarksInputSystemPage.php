				...
				<div class="row">
					...
					<div class="col-md-10 col-sm-10 col-lg-10 headerBox2">
						...
						<i class="glyphicon glyphicon-forward"></i>
							<a href="<?php echo site_url('resultSubModule'); ?>">Result</a>&nbsp;&nbsp;<i class="glyphicon glyphicon-forward"></i>&nbsp;&nbsp;<a href="<?php echo site_url('resultSubModule/examMarksInputSystem'); ?>">Student Mark's Input</a>
					</div>
				</div>	
	</div>
								  ...
								  <div id="widget-container-col-11" class="col-md-12 col-xs-12 col-sm-12 col-lg-12 widget-container-col ui-sortable addFormContent" style="min-height: 172px; display:block">
									<div id="widget-box-11" class="widget-box widget-color-dark ui-sortable-handle" style="opacity: 1;">
										<div class="widget-header">
											<h4 class="widget-title">Student Mark's Input</h4>
										...
										<div class="widget-body ">
											<div class="widget-main padding-4"  style="position: relative;">
												...
												<div class="scroll-content">
																		...
																		<div class="col-md-12">
																		 		<form class="form-horizontal" id="addForm" role="form" action="<?php echo site_url('resultSubModule/initialMarksInput'); ?>" enctype="multipart/form-data" method="post">	
																				 <div class="col-md-12 img-thumbnail  initialPart">
																						 ...
																						 <div class="col-md-6">
																							...
																							<div class="form-group">
																								  ...
																								  <div class="col-sm-7 paddingZero">
																										<select class="form-control " name="exam_type_id" id="exam_type_id" required="required">
...
$("#branch_id, #class_id, #year, #group_id, #section_id, #shift_id").on('change', function()
 {
	var branch_id = $('#branch_id').val();
	var class_id  = $('#class_id').val();
	...
	var formURL = "<?php echo site_url('resultSubModule/studentWiseSubjectList'); ?>";
	$.ajax(
	{
		url : formURL,
		type: "POST",
