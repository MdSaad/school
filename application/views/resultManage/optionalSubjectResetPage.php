<form id="resetSubject" action="<?php echo site_url('resultSubModule/optionalResetSubjectAction'); ?>" method="post">
   ...
   $("#resetSubject").submit(function(e)
    {
      ...
      $.ajax(
      {
        ...
        success:function(data){
          ...
          $("#optionalsubjectReset").modal('hide');
          location.reload();
        }
      });
