				...
				<div class="row">
					...
					<div class="col-md-10 col-sm-10 col-lg-10 headerBox2">
						...
						<i class="glyphicon glyphicon-forward"></i>
							...
							<i class="glyphicon glyphicon-forward"></i>&nbsp;&nbsp;<a href="<?php echo site_url('employeeInfo/empEssentialInfo'); ?>">Essential Information Management</a>
					</div>
				</div>	
	</div>
								  ...
								  <div id="widget-container-col-11" class="col-md-12 col-xs-12 col-sm-12 col-lg-12 widget-container-col ui-sortable addFormContent" style="min-height: 172px; display:block">
									<div id="widget-box-11" class="widget-box widget-color-dark ui-sortable-handle" style="opacity: 1;">
										<div class="widget-header">
											<h3 class="widget-title"><strong>Employee Essential Information Manage</strong></h3>
										...
										<div class="widget-body ">
											<div class="widget-main padding-4"  style="position: relative;">
												...
												<div class="scroll-content">
														<form class="form-horizontal" id="addForm" role="form" action="<?php echo site_url('employeeInfo/empEssentialInfoStore'); ?>" enctype="multipart/form-data" method="post">							
														<div class="content img-thumbnail container">
																	...
																	<div class="col-sm-3 text-left">
																	 ...
																	 <div class="col-sm-4">
																			<input type="text" class="form-control" name="emp_id" id="emp_id" placeholder="Enter Employee Id" required="required"/>
																	  </div>
																	  ...
																	  <div class="col-sm-4">
																		<div class="input-group">
																			...
																			<?php foreach($bankListInfo as $v){ ?>
																			  <option value="<?php echo $v->id ?>" data-bank-name="<?php echo $v->bank_name ?>" ><?php echo $v->bank_name ?> </option>
																			<?php } ?>
																			</select>
																	...
																	<div class="form-group">
																	  ...
																	  <div class="col-sm-4">
																		 <input type="text" class="form-control" name="bank_list" id="bank_list" placeholder="Enter Bank List" required value=""/>
																	  </div>
																	  
																	  <label class="control-label col-sm-2" for="driving_licence"> Driving Licence :</label>
																	  <div class="col-sm-4">
																		<input type="text" class="form-control" name="driving_licence" id="driving_licence" placeholder="Enter Driving Licence" value=""/>
																	  </div>
																	</div>
																	  ...
																	  <div class="col-sm-4">
																		<div class="input-group">
																			...
																			<?php foreach($bankBranchListInfo as $v){ ?>
																			  <option value="<?php echo $v->id ?>" data-bankBranch-name="<?php echo $v->branch_name ?>" ><?php echo $v->branch_name ?> </option>
																			<?php } ?>
																			</select>
																	...
																	<div class="form-group">
																	  ...
																	  <div class="col-sm-4">
																		<textarea class="form-control" name="address" id="address" placeholder="Enter Bank Address"></textarea>
																	  </div>
																	  
																	  
																	  <label class="control-label col-sm-2" for="passport_no"> Passport :</label>
																	  <div class="col-sm-4">
																		 <input  type="text" class="form-control" name="passport_no" id="passport_no" placeholder="Enter Passport" value=""/>
																	  </div>
																	...
																	<div class="form-group">
																	  ...
																	  <div class="col-sm-4">
																		 <input  type="text" class="form-control" name="account_no" id="account_no" placeholder="Enter Account No" value=""/>
																	  </div>
																	  ...
																	  <div class="col-sm-4">
																		<div class="input-group">
																			<input id="passport_issu_date" name="passport_issu_date" class="form-control date-picker" type="text" data-date-format="dd-mm-yyyy" placeholder="Enter Passport Issue Date" >
																	...
																	<div class="form-group">
																	  ...
																	  <label class="control-label col-sm-2" for="visited_country">Visited Country :</label>
																	   <div class="col-sm-4">
																		<input type="text" class="form-control" name="visited_country" id="visited_country" placeholder="Enter Visited Country" value=""/>
																	  </div>
																	</div>
																	...
																	<div class="form-group">
																	 ...
																	 <label class="control-label col-sm-2" for="nid">NID :</label>
																	  <div class="col-sm-4">
																			<input id="nid" name="nid" class="form-control" type="text"  placeholder="Enter NID" >
																	  </div>
																	 																	  
																	    <label class="control-label col-sm-2" for="tin">TIN :</label>
																	     <div class="col-sm-4 text-left">
																		<input type="text" class="form-control" name="tin" id="tin" placeholder="Enter TIN" value=""/>
																	  </div>
																	</div>
														...
														<div class="alert alert-block alert-success afterSubmitContent" id="">
																...
																<span class="alrtText">Employee Essential Information Added Successfully. Add Again Click <strong class="btn-danger tryAgain">Here</strong></span>
															</div>
												</div>
											</div>
										</div>
...
$("#addNewBranch").submit(function(e)
	...
	$("#addForm input[type='text'], #addForm input[type='hidden'], #addForm input[type='number'], #addForm input[type='email']").val("");
