       ...
       <div class="row msg_container base_sent">
          ...
          <div class="col-md-2 col-xs-2 avatar">
            <?php if(!empty($userDetails->image)){ ?>
              <img style="display: block; width: 100%;" src="<?php echo base_url("Images/Register_image/$userDetails->image"); ?>">
            <?php }else{ ?>
        ...
        <div class="row msg_container base_receive">
          <div class="col-md-2 col-xs-2 avatar">
             <?php if(!empty($v->image)){ ?>
               <img style="display: block; width: 100%;" src="<?php echo base_url("Images/Register_image/$v->image"); ?>">
             <?php }else{ ?>
               <img src="<?php echo base_url("resource/img/profile2.png"); ?>"align="right" class="img-responsive" />
            <?php } ?>
          </div>
