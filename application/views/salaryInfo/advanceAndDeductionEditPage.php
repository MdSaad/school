								  ...
								  <div id="widget-container-col-11" class="col-md-12 col-xs-12 col-sm-12 col-lg-12 widget-container-col ui-sortable addFormContent" style="min-height: 172px; display:block">
									<div id="widget-box-11" class="widget-box widget-color-dark ui-sortable-handle" style="opacity: 1;">
										...
										<div class="widget-body ">
											...
											<form class="form-horizontal" id="addForm" role="form" action="<?php echo site_url('salaryManageSystem/advanceAndDeductionEditInfoChk'); ?>" enctype="multipart/form-data" method="post">
												<div class="scroll-content">
															<div class="content img-thumbnail container">
																	<div class="form-group" style="padding-top:10px;">
																		...
																		<label class="control-label col-sm-2"><strong>Month  :</strong></label>			
																		<div class="col-sm-3 text-left">
																			<input name="month" id="month" class="form-control date-picker" type="text" placeholder="Enter Advance & Deductions  Month" required="required">
																		</div>
