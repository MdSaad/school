											  ...
											  <div class="content img-thumbnail container" style="padding-top:15px;">
													<div class="col-md-12">
													  <!-- Nav tabs -->
													   ...
													   <li role="presentation" class="active"><a href="#advanced" aria-controls="advanced" role="tab" data-toggle="tab">Add Advance</a></li>
														<li role="presentation"><a href="#deduction" aria-controls="deduction" role="tab" data-toggle="tab">Add Deduction</a></li>
													  ...
													  <div class="tab-content">
    													 <div role="tabpanel" class="tab-pane active" id="advanced"> 
															 <form class="form-horizontal" id="advancedAddForm" role="form" action="<?php echo site_url('salaryManageSystem/empAdvancedAction'); ?>" enctype="multipart/form-data" method="post">	
															    <input type="hidden" name="empId" id="empId" value="<?php echo $empID ?>" />
											 					<input type="hidden" name="monthYear" id="monthYear" value="<?php echo $monthYear ?>" />
															     <div class="form-group">
																	  <label class="control-label col-sm-2" for="advanced_amount">Advanced Amount* :</label>
																	  <div class="col-sm-4">
																			<input required="required" type="text" class="form-control" name="advanced_amount" id="advanced_amount" placeholder="Enter Advanced Amount*" value=""/>
																	  </div>
																	  
																	  <label class="control-label col-sm-2" for="total_installment">Total Installment :</label>
																	  <div class="col-sm-4">
																			<input type="text" class="form-control" name="total_installment" id="total_installment" placeholder="Enter Total Installment" value=""/>
																	  </div>
																 ...
																 <div class="form-group">
																	  ...
																	  <div class="col-sm-4">
																			<input type="text" class="form-control" name="payable_amount" id="payable_amount" placeholder="Enter Monthly Payment Amount" value=""/>
																	  </div>
																 ...
																 <div class="form-group">
																	  <label class="control-label col-sm-2" for="advanced_reason">Advanced Reason :</label>
																	  <div class="col-sm-4">
																	        <select class="form-control" name="advanced_reason" id="advanced_reason" required>
																	  ...
																	  <div class="col-sm-4">
																			<input type="text" class="form-control date-picker" name="advanced_start_date" id="advanced_start_date" placeholder="Enter Advanced Start Date" value=""/>
																	  </div>
																	
																</div>
																
																 <div class="form-group">
																	  <label class="control-label col-sm-2" for="payable_month">Payable Month :</label>
																	  <div class="col-sm-4">
														     ...
														     <form class="form-horizontal" id="deductionAddForm" role="form" action="<?php echo site_url('salaryManageSystem/empDeductionAction'); ?>" enctype="multipart/form-data" method="post">	
															    <input type="hidden" name="empId" id="empId" value="<?php echo $empID ?>" />
																 ...
																 <div class="form-group">
																	  ...
																	  <div class="col-sm-4">
																			<input type="text" class="form-control" name="deduction_reason" id="deduction_reason" placeholder="Enter Deduction Reason" value=""/>
																	  </div>
