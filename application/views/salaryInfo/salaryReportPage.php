...
<html lang="en-US">
	...
	<div class="col-md-11 col-lg-11 headerBox" >
				...
				<div class="row">
					...
					<div class="col-md-10 col-sm-10 col-lg-10 headerBox2">
						...
						<i class="glyphicon glyphicon-forward"></i>
							<a href="<?php echo site_url('allReport'); ?>">Report</a>&nbsp;&nbsp;<i class="glyphicon glyphicon-forward"></i>&nbsp;&nbsp;<a href="<?php echo site_url('hrReport'); ?>">HR Report</a>&nbsp;&nbsp;<i class="glyphicon glyphicon-forward"></i>&nbsp;&nbsp; <a href="<?php echo site_url('hrReport/salaryReport'); ?>">Salary Report</a>&nbsp;&nbsp;
					</div>
				</div>	
	</div>
								  ...
								  <div id="widget-container-col-11" class="col-md-12 col-xs-12 col-sm-12 col-lg-12 widget-container-col ui-sortable addFormContent" style="min-height: 172px; display:block">
									<div id="widget-box-11" class="widget-box widget-color-dark ui-sortable-handle" style="opacity: 1;">
										<div class="widget-header">
											<h3 class="widget-title"><strong>Employee Salary Report Management</strong></h3>
									...
									<div class="row">
										<div class="col-xs-12 col-md-12 col-lg-12 col-sm-12">
											...
											<div class="text-left">
												...
												<form class="form-horizontal" id="salaryReportForm" role="form" action="<?php echo site_url('hrReport/empSalarySalaryReport'); ?>" enctype="multipart/form-data" method="post">	
												  <div class="scroll-content">
	  ...
	  <?php $this->load->view('common/footer'); ?>
	   ...
	   <!-- Emp Salary Modal start -->
	  <div class="modal fade" id="saladetailsDetails" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
...
$('.date-picker').datepicker({
 ...
 $(document).on("submit", "#salaryReportForm", function(e){
  	...
  	$.ajax(
			{
				...
				success:function(data){
					$("#saladetailsDetails .modal-content").html(data);
					$("#saladetailsDetails").modal({
						keyboard: false,
						backdrop: 'static',
					});
					$("#saladetailsDetails").modal('show');
