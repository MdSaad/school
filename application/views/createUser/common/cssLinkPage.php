	<!-- bootstrap & fontawesome -->
		...
		<!-- ace styles -->
		<link rel="stylesheet" href="<?php echo base_url("resource/assets/css/ace.min.css"); ?>" class="ace-main-stylesheet" id="main-ace-style" />
        <link rel="stylesheet" href="<?php //echo base_url("resource/assets/css/datepicker.css"); ?>" />
        <link rel="stylesheet" href="<?php echo base_url("resource/assets/css/datepicker.min.css"); ?>" />
		
		<link rel="stylesheet"  href="<?php echo base_url("resource/assets/css/ace-skins.min.css"); ?>" />
