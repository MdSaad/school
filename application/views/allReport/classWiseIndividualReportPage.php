				...
				<div class="row">
					...
					<div class="col-md-10 col-sm-10 col-lg-10 headerBox2">
						...
						<i class="glyphicon glyphicon-forward"></i>
							<a href="<?php echo site_url('allReport'); ?>">Report</a>&nbsp;&nbsp;<i class="glyphicon glyphicon-forward"></i>&nbsp;&nbsp;<a href="<?php echo site_url('allReport/resultReportModule'); ?>">Result Report</a>&nbsp;&nbsp;<i class="glyphicon glyphicon-forward"></i>&nbsp;&nbsp;<a href="<?php echo site_url('allReport/classWiseIndividualReport'); ?>">Class Wise Individual Result Report</a>
					</div>
				</div>	
	</div>
								  ...
								  <div id="widget-container-col-11" class="col-md-12 col-xs-12 col-sm-12 col-lg-12 widget-container-col ui-sortable addFormContent" style="min-height: 172px; display:block">
									<div id="widget-box-11" class="widget-box widget-color-dark ui-sortable-handle" style="opacity: 1;">
										<div class="widget-header">
											<h3 class="widget-title"><strong>Class Wise Individual Result Report</strong></h3>
										...
										<div class="widget-body ">
											<div class="widget-main padding-4"  style="position: relative;">
												...
												<div class="scroll-content">
														<form target="_blank" class="form-horizontal" id="findReportResultList" role="form" action="<?php echo site_url('allReport/classWiseIndividualReportAction'); ?>"  enctype="multipart/form-data" method="post">	
												<div class="scroll-content">
