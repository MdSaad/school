				...
				<div class="row">
					...
					<div class="col-md-10 col-sm-10 col-lg-10 headerBox2">
						...
						<i class="glyphicon glyphicon-forward"></i>
							<a href="<?php echo site_url('allReport'); ?>">Report</a>&nbsp;&nbsp;<i class="glyphicon glyphicon-forward"></i>&nbsp;&nbsp;<a href="<?php echo site_url('attendenceReport'); ?>">Attendence Report</a>&nbsp;&nbsp;<i class="glyphicon glyphicon-forward"></i>&nbsp;&nbsp;<a href="<?php echo site_url('attendenceReport/dailyAttnSummaryReport'); ?>">Daily Attendence Summamry Report</a>&nbsp;&nbsp;
					</div>
				</div>	
	</div>
								  ...
								  <div id="widget-container-col-11" class="col-md-12 col-xs-12 col-sm-12 col-lg-12 widget-container-col ui-sortable addFormContent" style="min-height: 172px; display:block">
									<div id="widget-box-11" class="widget-box widget-color-dark ui-sortable-handle" style="opacity: 1;">
										<div class="widget-header">
											<h3 class="widget-title"><strong>Daily Attendence Summamry Report</strong></h3>
								...
								<div class="scroll-content">
									...
									<div class="row">
										<div class="col-xs-12 col-md-12 col-lg-12 col-sm-12">
											...
											<div class="text-left">
												<form class="form-horizontal" target="_blank" id="attendenceReportForm" role="form" action="<?php echo site_url('attendenceReport/dailyAtnSummaryReportAction'); ?>" enctype="multipart/form-data" method="get">	
												<div class="scroll-content">
