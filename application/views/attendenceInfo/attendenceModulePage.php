	  ...
	  <?php $this->load->view('common/header'); ?>
				...
				<div class="row">
					...
					<div class="col-md-10 col-sm-10 col-lg-10 headerBox2">
						...
						<i class="glyphicon glyphicon-forward"></i>
							<a href="<?php echo site_url('attendence'); ?>">Attentdence</a>
					</div>
				</div>	
	</div>
				...
				<div class="col-md-11 col-lg-11">
					...
					<div class="col-md-10 col-sm-10 col-lg-10 interfaceBody ">
						...
						<div class="col-md-6 col-sm-6 col-xs-12 boxShadow_1 moduleBox list-unstyled goModule" data-url="<?php echo site_url('attendence/manualAttendence'); ?>">
						...
						<div class="col-md-6 col-sm-6 col-xs-12 boxShadow_1 moduleBox list-unstyled goModule" data-url="<?php echo site_url('attendence/setupHoliday'); ?>">
