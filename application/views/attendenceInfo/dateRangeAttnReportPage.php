								...
								<div class="scroll-content">
									...
									<div class="row">
										<div class="col-xs-12 col-md-12 col-lg-12 col-sm-12">
											...
											<div class="text-left">
												<form class="form-horizontal" target="_blank" id="attendenceReportForm" role="form" action="<?php echo site_url('attendenceReport/dateRangeAttenReportAction'); ?>" enctype="multipart/form-data" method="get">	
												<div class="scroll-content">
