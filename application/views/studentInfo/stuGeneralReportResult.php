   ...
   <div class="modal-content">
		<div class="modal-header btn-primary" style="min-height:200px">
		...
		<?php if($stuDetailsInfo || $stuParentsDetailsInfo || $stuGuardianDetailsInfo)  { 
		 ...
		 <?php if(!empty($stuDetailsInfo)) { ?>
		 	<div id="generalReport">
		 		<div class="midTitle">Student Details Information 
		 ...
		 <?php if(isset($stuParentsDetailsInfo)) { ?>
	 	  <div id="generalReport">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-responsive table-condensed">
					  ...
					  <tr>
					    <td align="left" valign="middle"><strong>Father's image</strong></td>
					    <td align="center" valign="middle"><strong>:</strong></td>
					    <td align="left" valign="middle">
						 <?php if(!empty($stuParentsDetailsInfo->father_photo)){ ?>
						   <img src="<?php echo base_url("resource/parents_gardian_photo/$stuParentsDetailsInfo->father_photo") ?>" width="50" height="50" />
						 <?php } else { ?>
							 <img src="<?php echo base_url('resource/img/male.png'); ?>" width="50" height="50">  
						 <?php }  ?>
					    ...
					    <td>&nbsp;</td>
					    <td><strong>Mother's</strong> <strong>image</strong> </td>
					    <td align="center" valign="middle"><strong>:</strong></td>
					    <td align="left" valign="middle">
						    <?php if(!empty($stuParentsDetailsInfo->mother_photo)){ ?>
						   <img src="<?php echo base_url("resource/parents_gardian_photo/$stuParentsDetailsInfo->mother_photo") ?>" width="50" height="50" />
						 <?php } else { ?>
							 <img src="<?php echo base_url('resource/img/EmptyProfile.png'); ?>" width="50" height="50">  
						 <?php }  ?>
		 	...
		 	<div id="generalReport">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-responsive table-condensed">
					  ...
					  <tr>
						...
						<td width="3%" align="center" valign="middle" ><strong>:</strong></td>
						<td width="26%" align="left" valign="middle" ><?php echo $stuGuardianDetailsInfo->g_occupation_adrs; ?></td>
					  </tr>
					  <tr>
						<td align="left" valign="middle"><strong>Present Address </strong></td>
						<td align="center" valign="middle"><strong>:</strong></td>
						...
						<td align="center" valign="middle"><strong>:</strong></td>
						<td align="left" valign="middle"><?php echo $stuGuardianDetailsInfo->g_mobile; ?></td>
					  </tr>
					  <tr>
						<td align="left" valign="middle"><strong>Permanent Address  </strong></td>
						<td align="center" valign="middle"><strong>:</strong></td>
						...
						<td align="center" valign="middle"><strong>:</strong></td>
						<td align="left" valign="middle"><?php echo $stuGuardianDetailsInfo->g_email; ?></td>
					  </tr>
					  <tr>
						<td align="left" valign="middle"><strong>Occupation </strong></td>
						<td align="center" valign="middle"><strong>:</strong></td>
						...
						<td align="left" valign="middle"><strong>Passport No </strong></td>
						<td align="center" valign="middle"><strong>:</strong></td>
						<td align="left" valign="middle"><?php echo $stuGuardianDetailsInfo->g_passport_no; ?></td>
					  </tr>
					  <tr>
						<td align="left" valign="middle"><strong>Guardian image</strong></td>
						<td align="center" valign="middle"><strong>:</strong></td>
						<td align="left" valign="middle">
						 <?php if(!empty($stuParentsDetailsInfo->guardian_photo)){ ?>
						   <img src="<?php echo base_url("resource/parents_gardian_photo/$stuParentsDetailsInfo->guardian_photo") ?>" width="50" height="50" />
						 <?php } else { ?>
							 <img src="<?php echo base_url('resource/img/EmptyProfile.png'); ?>" width="50" height="50">  
						 <?php }  ?>
						</td>
						...
						<td align="left" valign="middle"><strong>National ID </strong></td>
						<td align="center" valign="middle"><strong>:</strong></td>
						<td align="left" valign="middle"><?php echo $stuGuardianDetailsInfo->g_nid; ?></td>
					  </tr>
