				...
				<div class="row">
					...
					<div class="col-md-10 col-sm-10 col-lg-10 headerBox2">
						...
						<i class="glyphicon glyphicon-forward"></i>
							<a href="<?php echo site_url('FeeCollectionModule'); ?>">Fee Collection</a> <i class="glyphicon glyphicon-forward"></i> <a href="<?php echo site_url('feeCollectionModule/feeSetup'); ?>">Setup</a> <i class="glyphicon glyphicon-forward"></i> <a href="<?php echo site_url('feeCollectionModule/feeHeadCreate'); ?>">Fee Head Create</a>
					</div>
				</div>	
	</div>
								  ...
								  <div id="widget-container-col-11" class="col-md-12 col-xs-12 col-sm-12 col-lg-12 widget-container-col ui-sortable addFormContent" style="min-height: 172px; display:block">
									<div id="widget-box-11" class="widget-box widget-color-dark ui-sortable-handle" style="opacity: 1;">
										<div class="widget-header">
											<h3 class="widget-title"><strong>Fee Head Create</strong></h3>
										...
										<div class="widget-body ">
											<div class="widget-main padding-4"  style="position: relative;">
												<form class="form-horizontal" id="addForm" role="form" action="<?php echo site_url('feeCollectionModule/storeFeeHead'); ?>" enctype="multipart/form-data" method="post">	        <input type="hidden" name="update_id" id="update_id" value="" />
																				 ...
																				 <div class="col-md-12 img-thumbnail boxShadow_1 initialPart">
																						 ...
																						 <div class="col-md-6">
																							 <div class="form-group">
																								  <label class="control-label col-sm-5 " for="cat_id">Category Name :</label>
																								  <div class="col-sm-7 paddingZero">
																											<?php 
																												$catList	= $this->M_crud->findAll('fee_head_cat_list_manage', array(), 'id', 'asc'); 
																											?>
																											<select class="form-control" name="cat_id" id="cat_id" required="required">
																						 ...
																						 <div class="col-md-6">
																							<div class="form-group">
																								  <label class="control-label col-sm-5 " for="head_name">Head Name :</label>
																								  <div class="col-sm-7 paddingZero">
																										<input type="text" name="head_name" id="head_name" class="form-control" required="required"  />		
																									</div>
																							</div>
																						 </div>
																					</div>	
																	...
																	<table class="table table-bordered table-striped">
																		<thead class="thin-border-bottom">
																			<tr>
																				...
																				<th class="text-center">
																					<i class="ace-icon fa fa-caret-right blue"></i>Head Name
																				</th>
																				<th class="text-center">
																		...
																		<tbody>
																			...
																			$SL	= 1;
																			$SL	= $onset+$SL;
																			foreach($feeHeadList as $v) { 
																			$catInfo	= $this->M_crud->findById('fee_head_cat_list_manage', array('id' => $v->cat_id));
																			?>
																			<tr>
																				<td><?php echo $SL++; ?></td>
																				<td><?php echo $catInfo->cat_name; ?></td>
...
$(document).on("click", ".green", function()
	{
		...
		var formURL = "<?php echo site_url('crud/edit/fee_head_list_manage/id'); ?>";
		$('.update').text('Update');
		$.ajax(
		{
			url : formURL,
	...
	$('.red').on('click', function() {
			...
			if(x){
				var id = $(this).attr('data-id');
				console.log(id);
				var url = SAWEB.getSiteAction('crud/delete/fee_head_list_manage/id/'+id);
