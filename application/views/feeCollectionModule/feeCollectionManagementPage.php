				...
				<div class="row">
					...
					<div class="col-md-10 col-sm-10 col-lg-10 headerBox2">
						...
						<i class="glyphicon glyphicon-forward"></i>
							<a href="<?php echo site_url('feeCollectionModule'); ?>">Fee Collection</a>&nbsp;&nbsp;<i class="glyphicon glyphicon-forward"></i>&nbsp;&nbsp;<a href="<?php echo site_url('feeCollectionModule/feeSetup'); ?>">Setup</a>&nbsp;&nbsp;<i class="glyphicon glyphicon-forward"></i>&nbsp;&nbsp;<a href="<?php echo site_url('feeCollectionModule/collectionManagment'); ?>">Class Wise Applicable </a>
					</div>
				</div>	
	</div>
								  ...
								  <div id="widget-container-col-11" class="col-md-12 col-xs-12 col-sm-12 col-lg-12 widget-container-col ui-sortable addFormContent" style="min-height: 172px; display:block">
									<div id="widget-box-11" class="widget-box widget-color-dark ui-sortable-handle" style="opacity: 1;">
										<div class="widget-header">
											<h4 class="widget-title">Class Wise Applicable</h4>
										...
										<div class="widget-body ">
											...
											<form class="form-horizontal" id="addForm" role="form" action="<?php echo site_url('feeCollectionModule/feeCollectionMode'); ?>" enctype="multipart/form-data" method="post">	
												<div class="scroll-content">
																		 <div class="content img-thumbnail container">
																		<div class="col-md-12">
																		 <div class="row textleft">
																					<h4 class="text-left"> Payment Head Selection </h4>
																				</div>
...
$(".initialize").on('click', function()
{
	...
	var formURL = '<?php echo site_url('feeCollectionModule/initialPayColl'); ?>';
